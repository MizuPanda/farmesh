...
function isProposedMatchArgs(value: unknown): value is ProposedMatchArgs {
...
`;
    ...
    const proposedMatches: Awaited<ReturnType<typeof handleProposedMatch>>[] = [];
